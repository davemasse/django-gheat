...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Point.date_added'
        db.add_column('gheat_point', 'date_added', self.gf('django.db.models.fields.DateTimeField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Point.date_added'
        db.delete_column('gheat_point', 'date_added')
